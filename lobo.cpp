...
char fazenda[252][252];
int busca_valida = 0;

int ovelhas_pasto = 0, lobos_pasto = 0;
int ovelhas_vivas = 0, lobos_vivos = 0;
...
int main()
{
    ...
    cout << ovelhas_vivas << " " << ovelhas_pasto << "\n";
